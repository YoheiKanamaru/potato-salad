      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              <MenuItem onClick={handleCloseUserMenu}><Link to={'/'}><b style={{color: "white"}}>Home</b></Link></MenuItem>
              <MenuItem onClick={handleCloseUserMenu}><Link to={'/about'}><b style={{color: "white"}}>About</b></Link></MenuItem>
              <MenuItem onClick={handleCloseUserMenu}><Link to={'/contact'}><b style={{color: "white"}}>Contact</b></Link></MenuItem>
          </Box>
